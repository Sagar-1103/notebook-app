...
export default function Noteitem() {
  ...
  return (
    ...
    <div className="container mx-auto flex flex-wrap">
      ...
      {/* ?????? */}
      <div className={`fixed top-0 left-0 w-full h-full flex items-center justify-center z-10 ${modalClick ? '' : 'hidden'}`}>
      <div className="modal-container  relative">
        <div className="modal-content xl:w-96 lg:w-96 md:w-96 sm:w-80 w-64 border-black border-solid border-2 bg-white p-6 rounded-lg shadow-lg">
